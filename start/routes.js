...
Route.group(() => {
  ...
  Route.put(
    "psw-update/:token",
    "PasswordController.updatePasswordByToken"
  ).validator("AuthPasswordByToken");
})
  .prefix("auth")
  .namespace("Auth");
...
Route.group(() => {
  ...
  Route.put("profile-update", "ProfileController.update").validator(
    "AuthProfile"
  );
  Route.put("psw-update", "PasswordController.updatePassword").validator(
    "AuthPassword"
  );
})
  .prefix("auth")
